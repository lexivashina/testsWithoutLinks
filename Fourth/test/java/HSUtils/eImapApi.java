...
public class eImapApi {
    private final String emailSubjectLabel            = "aa Email Validation";
    private final String passwordRecoverySubjectLabel = "aa Password Recovery";
    ...
    public eImapApi(String email, String password) {
        ...
        this.findTargetMessage(passwordRecoverySubjectLabel);
    }
    ...
    private void tryToFindTargetMessageInSpam()
    {
        for (String spamFolder : spamFolders)
        {
            ...
            targetMessage = (folderOpened) ? getTargetMessage(passwordRecoverySubjectLabel) : null;
            if (messageFound) {
                this.setVerificationCode();
                break;
            }
    ...
    private String parseVerificationCode(String content)
    {
        ...
        String verificationCode = Arrays.stream(contentSeparatedParts)
                ...
                .map(part -> part = part.split(verificationCodeEndSplitter)[1])
                .distinct()
                .findFirst()
                .orElse(null);
